        ...
        <div className="flex container mx-auto px-24 py-8 pb-24 justify-around items-baseline gap-8">
          <div>
            ...
            <div className="bg-grey-100 mt-3 p-10">
              <h2 className="pb-1 flex items-center gap-1 text-sm text-grey-600"><CurrencyDollar size={22} color={'#8047F8'}/>Pagamento</h2>
              <p className="pb-8 text-xs text-grey-400 pl-8">O pagamento é feito na entrega. Escolha a forma que deseja pagar</p>
                   ...
                   <div>
                     ...
                     <div className="flex items-center gap-2">
                       <div className="flex bg-grey-300 px-3 py-2 gap-1 items-center rounded-md">
                         ...
                         >
                           <img src={VectorPlus} className="text-sm" alt="" />
                         </button>
                       </div>
